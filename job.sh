...
srun python train.py  --hidden_channel 40 40 40 40 40 40   --kernel_size=5 --padding=2  --model_name=1nn_ising/h_4.5_unet_aug_l_train_$SLURM_ARRAY_TASK_ID --data_path=data/1nn_ising/unet_periodic_augmentation_$SLURM_ARRAY_TASK_ID\_l_4.5_h_300000_n.npz --model_type=REDENTnopooling --pooling_size=1 --epochs=3000 
